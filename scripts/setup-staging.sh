...
echo ""
echo "  2. Cloudflare AI Gateway: Create 'smoltbot-staging' gateway"
...
echo "  [ ] Observer staging running:     wrangler tail smoltbot-observer-staging"
